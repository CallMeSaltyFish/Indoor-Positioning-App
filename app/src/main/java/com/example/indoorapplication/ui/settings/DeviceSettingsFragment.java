...
import com.example.indoorapplication.MainActivity;
...
public class DeviceSettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        SimpleAdapter deviceViewAdapter = new SimpleAdapter(getContext(), deviceInfoItems, R.layout.view_device_item,
    ...
    private void showDeviceSettingDialog(final int idx) {
        AlertDialog.Builder deviceSettingDialog = new AlertDialog.Builder(getContext());
        final View dialogView = LayoutInflater.from(getContext()).inflate(R.layout.dialog_device_setting, null);
